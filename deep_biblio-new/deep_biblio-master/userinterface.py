...
def app_ui():
    ...
    ui.nav(
        ...
        ui.panel_main(
            ...
            ui.tags.img(src="deepbiblio.jpg", style="display: block;margin-left: auto;margin-right: auto;width: 50%;"),
            ui.tags.h6("Deep Biblio is an open-source and freely available for use, distributed under the MIT license.", style="text-align: center;"),
            ui.tags.h6("When Deep Biblio software are used in a publication, authors are required to cite the following reference:",
                       style="text-align: center;"),
            ui.tags.h6(
                ui.tags.em(ui.tags.b("Tiong Yew Tang (2023). Deep Bilio: A Python Tool for Deep Learning Biliometric Analysis. Journal of Informetics.",
                )),style="text-align: center;"),
            ui.tags.h6(
            ...
            ui.tags.div(ui.tags.a("email: tiongyewt@sunway.edu.my", href="mailto:tiongyewt@sunway.edu.my;", align="center"), style="text-align: center;"),
            ...
            ui.layout_sidebar(
                ui.panel_sidebar(
                    ...
                    ui.input_select("load", "Choose your action:", {"demo": "Sample File", "import": "Raw File",
                                                                    "load":"Deep Biblio Excel File (xlsx)"}, selected=None),
    ...
    ui.nav_menu(
        ...
        ui.nav(
            ...
            ui.layout_sidebar(
                ui.panel_sidebar(
                    ...
                    ui.input_numeric("sources_most_relevant_sources_input_numeric", label="Number of sources:", value=10),
                    ui.input_action_button(
                ...
                ui.panel_main(
                    ui.navset_tab(
                        ...
                        ui.nav(
                            ...
                            ui.output_ui("sources_most_relevant_sources_description_analysis"),
                        ),
                    ),
                    width=9
                ),
        ...
        ui.nav(
            ...
            ui.layout_sidebar(
                ui.panel_sidebar(
                    ui.tags.h5("Click start to generate display:"),
                    ui.input_numeric("sources_most_local_cited_sources_input_numeric", label="Number of sources:",
                                     value=10),
                    ui.input_action_button(
            ...
            ui.layout_sidebar(
                ui.panel_sidebar(
                    ...
                    ui.input_numeric("authors_most_relevant_authors_input_numeric", label="Number of authors:",
                                     value=10),
                    ui.input_select("author_frequency_measure", "Frequency measure:", {"t": "N. of Documents", "p": "Percentange",
    ...
    ui.nav("Setting"),
    title=ui.tags.a("Deep Biblio", href="http://127.0.0.1:8000/", style="nav-link active;text-decoration: none;color: inherit;")
)